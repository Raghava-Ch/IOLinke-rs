...
pub mod pre_operate_m_sequence {
    ...
    pub const fn m_sequence_code() -> u8 {
        match dev_config::on_req_data::pre_operate::od_length() {
            1 => 0u8,
            2 => 1u8,
            8 => 2u8,
            32 => 3u8,
    ...
    pub const fn m_sequence_base_type() -> types::frame::msequence::MsequenceBaseType {
        use types::frame::msequence::MsequenceBaseType;
        use types::frame::msequence::MsequenceType::*;
        match m_sequence_type() {
            Type0 => MsequenceBaseType::Type0,
            Type11 => MsequenceBaseType::Type1,
            Type12 => MsequenceBaseType::Type1,
            Type1V => MsequenceBaseType::Type1,
            Type21 => MsequenceBaseType::Type2,
            Type22 => MsequenceBaseType::Type2,
            Type23 => MsequenceBaseType::Type2,
            Type24 => MsequenceBaseType::Type2,
            Type25 => MsequenceBaseType::Type2,
            Type2V => MsequenceBaseType::Type2,
        }
    }
}
...
pub const fn m_sequence_capability_parameter() -> iolinke_types::page::page1::MsequenceCapability {

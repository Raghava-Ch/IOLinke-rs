...
// };
// use iolinke_types::{
//     frame::msequence::{ComChannel, MsequenceBaseType, MsequenceCapability},
//     handlers::sm::{DeviceCom, DeviceIdent, DeviceMode, SioMode},
//     page::page1::{CycleTimeBuilder, ProcessDataInBuilder, ProcessDataOutBuilder, RevisionIdBuilder},
//     frame::msequence::TransmissionRate,
// };
// use iolinke_device::{test_utils, IoLinkDevice, ThreadMessage, take_care_of_poll};
// fn main() {

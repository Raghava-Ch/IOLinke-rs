...
mod preop_tests {
    ...
    use iolinke_device::{config, test_utils::IsduService, DataStorageIndexSubIndex, DeviceParametersIndex, SubIndex};
    ...
    #[test]
fn mock_test_write_data_storage_index_and_read_back() {
    // Set up test environment
    let (_io_link_device, poll_tx, poll_response_rx) = test_utils::setup_test_environment();
